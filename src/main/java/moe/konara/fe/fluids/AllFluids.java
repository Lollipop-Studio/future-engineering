...
public class AllFluids {
    ...
    public static final RegistryObject<FlowingFluid> WEIRD_SPRING_WATER = FLUIDS.register("weird_spring_water", () -> new ForgeFlowingFluid.Source(
            AllFluids.PROPERTIES));
    public static final RegistryObject<FlowingFluid> WEIRD_SPRING_WATER_FLOWING = FLUIDS.register("weird_spring_water_flowing", () -> new ForgeFlowingFluid.Flowing(
            AllFluids.PROPERTIES));
    public static final ForgeFlowingFluid.Properties PROPERTIES = new ForgeFlowingFluid.Properties(WEIRD_SPRING_WATER, WEIRD_SPRING_WATER_FLOWING, FluidAttributes
